...
import { colors, defaultImg, defaultStyles, formHeading } from '../styles/styles'
                        ...
                        <>
                            ...
                            <View>
                                ...
                                <View style={{
                                    ...
                                    <ButtonBox handler={navigateHandler} text={"Log Out"} icon={"exit-to-app"} />
...
const styles = StyleSheet.create({
    container: {
        elevation: 7, backgroundColor: colors.color3,
        padding: 30,
        borderRadius: 10,
        alignItems: "center",
